      ...
      <footer className="bg-[#1a1a1a] text-stone-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="col-span-2 md:col-span-1">
              <Link to="/" className="inline-flex items-center gap-2 mb-3">
                <div className="relative w-8 h-8">
                  <div className="absolute inset-0 rounded-full bg-gradient-to-br from-[#10665c] via-[#7c4d8f] to-[#b695c8] opacity-30" />
                  <svg className="absolute inset-0 w-8 h-8" viewBox="0 0 40 40" fill="none">
                    <polygon points="20,6 34,20 20,34 6,20" stroke="#b695c8" strokeWidth="1" fill="none" opacity="0.6" />
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.tiktok.com/@crystalbloomery" target="_blank" rel="noopener noreferrer" className="text-stone-500 hover:text-white transition-colors" aria-label="TikTok">
            ...
            {/* Explore */}
            <div>
              <h4 className="font-sans text-xs tracking-widest uppercase text-stone-500 mb-3">Explore</h4>
            ...
            {/* Services */}
            <div>
              <h4 className="font-sans text-xs tracking-widest uppercase text-stone-500 mb-3">Services</h4>
              <nav className="space-y-2">
          ...
          {/* Bottom */}
          <div className="mt-8 pt-6 border-t border-stone-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-stone-600">
            <span>© {new Date().getFullYear()} Crystal Bloomery</span>
