...
export default function Wholesale() {
  ...
  const benefits = [
    {
      ...
      description: "Access to our full range of handcrafted Bloom Satchels and crystal offerings at wholesale pricing."
    },
    {
      icon: Heart,
  ...
  return (
    <>
      <Helmet>
        <title>Wholesale Bloom Satchels & Crystal Ceremony Kits | Handmade in Asheville, NC</title>
        <meta name="description" content="Stock your boutique with handmade mystery Bloom Satchels. Unique crystal & herbal ceremony kits from Asheville, NC. Join our stockist program for exclusive pricing." />
        <meta name="keywords" content="wholesale crystals, bulk bloom satchels, metaphysical wholesale, wellness retail, crystal shop supplier, Asheville wholesale" />
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="font-sans text-stone-600 max-w-2xl mx-auto">
              Beyond our signature Bloom Satchels, we offer special items that can be curated 
