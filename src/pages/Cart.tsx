...
import { ShoppingBag, ArrowRight, Loader2, Lock } from 'lucide-react';
                ...
                <div>
                  ...
                  <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center text-xs">
                      <span className="bg-[#ebe8e3] px-4 text-stone-400 uppercase tracking-widest">Or pay with card</span>
                    </div>
                  </div>
                ...
                <div className="bg-stone-50 rounded-lg p-5 flex flex-col h-fit sticky top-32">
                  ...
                  <div className="border-t border-stone-300 pt-5 mb-6">
                    <div className="flex justify-between items-baseline">
                      ...
                      <span className="font-serif text-3xl text-stone-900">${(item.price * item.quantity).toFixed(2)}</span>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-3 gap-12 max-w-3xl mx-auto py-8">
              <div className="text-center">
                <div className="w-12 h-12 mx-auto mb-3 flex items-center justify-center">
                  <svg className="w-8 h-8 text-[#10665c]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                  </svg>
                </div>
                <span className="text-xs text-stone-600 tracking-wide uppercase">Secure Payment</span>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 mx-auto mb-3 flex items-center justify-center">
                  <svg className="w-8 h-8 text-[#10665c]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                <span className="text-xs text-stone-600 tracking-wide uppercase">Free Shipping</span>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 mx-auto mb-3 flex items-center justify-center">
                  <svg className="w-8 h-8 text-[#10665c]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                ...
                <span className="text-xs text-stone-600 tracking-wide uppercase">Handcrafted</span>
              </div>
            </div>
          </div>
        )}
