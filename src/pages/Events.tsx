...
export default function Events() {
  return (
    <>
      <Helmet>
        <title>Spirit Blooms Gifts and Favors | Crystal Bloomery Events</title>
        <meta name="description" content="Custom Spirit Blooms for weddings, celebrations, and special events. Bulk pricing and personalized messages available for your sacred occasion." />
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        ...
        >
          ...
          <p className="font-sans text-stone-600 max-w-2xl mx-auto leading-relaxed text-lg">
            Celebrate life's sacred moments with custom Spirit Blooms for weddings and special events.
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          >
            <div className="text-center mb-8">
              <h2 className="font-serif text-2xl sm:text-3xl text-stone-800 mb-2">The Bespoke Spirit Blooms</h2>
            ...
            <div className="bg-white/80 backdrop-blur-sm p-8 sm:p-10 rounded-lg border border-stone-200 mb-8">
              <p className="font-sans text-stone-600 leading-relaxed text-center max-w-3xl mx-auto mb-8">
                Move beyond the ordinary. Our signature velvet Spirit Blooms are thoughtfully crafted, fully customizable 
                ritual favors designed to hold the unique energy of your gathering. Whether celebrating a wedding, hosting 
                a private retreat, or marking a meaningful milestone, each Spirit Blooms is curated with intention to reflect 
            ...
            <p className="font-sans text-stone-600 leading-relaxed text-center max-w-3xl mx-auto">
              ...
              message of love, peace, and happiness in each of our Spirit Blooms.
            </p>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="font-sans text-stone-600 max-w-2xl mx-auto">
                A glimpse at the unique additions we can include in your bespoke Spirit Blooms.
              </p>
            </div>
          ...
          >
            ...
            <p className="font-sans text-stone-600 mb-6 max-w-2xl mx-auto">
              Every event is unique, and we'd love to help craft Spirit Blooms that perfectly honor your special occasion. 
