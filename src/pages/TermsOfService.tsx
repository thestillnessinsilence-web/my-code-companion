      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <section className="mb-8">
            ...
            <p className="font-sans text-stone-600 leading-relaxed">
              <strong>Mystery Items:</strong> "Bloom Satchels" is a mystery item. By purchasing, you acknowledge 
          ...
          <section className="mb-8">
            ...
            <p className="font-sans text-stone-600 leading-relaxed">
              <strong>Mystery Bags:</strong> "Bloom Satchels" is a final sale item due to its mystery nature, 
