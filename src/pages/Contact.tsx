...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Crystal Bloomery | Questions About Bloom Satchels</title>
        <meta name="description" content="Get in touch with Crystal Bloomery. Ask questions about our handcrafted Bloom Satchels, wholesale inquiries, or custom event orders. We'd love to connect with you." />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        ...
        >
          ...
          <p className="font-sans text-stone-600 max-w-xl mx-auto leading-relaxed">
            We'd love to hear from you. Whether you have questions about our Bloom Satchels 
          ...
          >
            ...
            <div className="relative p-6 sm:p-8 bg-gradient-to-br from-[#e8f5f2] to-[#f3eef5]">
              ...
              <p className="font-serif text-lg sm:text-xl text-stone-700 italic leading-relaxed">
                ...
                with the same intention we pour into every Bloom Satchel."
              </p>
